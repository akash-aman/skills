...
description: "Release notes one-page HTML with highlights, Added, Fixed, Breaking changes, Known issues, and Upgrade note. Writes explicit \"None\" style sections whenever the user does not provide details. Trigger keywords: release notes, changelog, what's new, version update, change log, release summary."
---
