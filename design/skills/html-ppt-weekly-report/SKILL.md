...
description: "Team weekly / status-update deck — corporate clarity, 8-cell KPI grid, shipped list, 8-week bar chart, next-week table. Use for 周报, business reviews, team status updates, and exec dashboards. Trigger keywords: weekly report, 周报, status update, team report, business review, wbr."
---
