---
name: kanban-board
description: "Kanban / task board with columns (To do / In progress / In review / Done), draggable-looking cards, assignee avatars, swimlanes, and a top filter bar. Use when the brief mentions \"kanban\", \"task board\", \"sprint board\", \"trello\", \"看板\". Trigger keywords: kanban, task board, sprint board, trello, jira board, 看板."
---
