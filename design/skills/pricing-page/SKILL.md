---
name: pricing-page
description: "A standalone pricing page — header, plan tiers, feature comparison table, and an FAQ. Use when the brief asks for \"pricing\", \"plans\", \"subscription tiers\", or a \"compare plans\" page. Trigger keywords: pricing, pricing page, plans, subscription, compare plans, 定价, 套餐."
---
